...
AlefMaqsoora 	= Harf( u'\u0649', u'\uFEEF', u'\uFEF0', u'\u0640', u'\u0640', False, False ) #this one is problematic, as its medial form is not available, and it doesn't have an initial form, so for that I'm using the ـ kashida/tatweel 
